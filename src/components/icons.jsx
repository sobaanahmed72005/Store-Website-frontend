...
export function PlusCircleIcon({ className = '', size = 20 }) {
  return (
...
export function MinusCircleIcon({ className = '', size = 20 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} className={className} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function LocationIcon({ className = '', size = 24 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size} height={size} className={className} fill="currentColor">
...
export function FacebookIcon({ className = '', size = 24 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size} height={size} className={className} fill="currentColor">
      <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131c.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
    </svg>
  )
}

export function TwitterIcon({ className = '', size = 24 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size} height={size} className={className} fill="currentColor">
...
export function MinusIcon({ className = '', size = 15 }) {
  return (
    <svg
...
export function PlusIcon({ className = '', size = 15 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 16 16"
...
export function ListIcon({ className = '', size = 16 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 16 16"
...
export function CheckIcon({ className = '', size = 11 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 16 16"
...
export function AccountIcon({ className = '', size = 28 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 16 16"
...
export function HeartIcon({ className = '', size = 28, filled = false }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function HamburgerIcon({ className = '', size = 28 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function CartIcon({ className = '', size = 28 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function CloseIcon({ className = '', size = 14 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 14 14" fill="none" className={className}>
      <path
        fill="currentColor"
...
export function PkrFlagIcon({ className = '', size = 20 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
    ...
    >
      ...
      <g mask="url(#pkrFlagMask)">
        <path fill="#eee" d="M0 0h133.6l50.2 252.5L133.6 512H0z" />
        <path fill="#496e2d" d="M133.6 0H512v512H133.6z" />
        <path
          fill="#eee"
          d="M365.5 298.3A72.3 72.3 0 1 1 313.7 168a89 89 0 1 0 74.6 103.2a72 72 0 0 1-22.8 27.2zM364 167l18.2 19.6l24.3-11.3l-13 23.5l18.2 19.6l-26.3-5.1l-13 23.4l-3.3-26.7l-26.1-5l24.4-11.3z"
        />
      </g>
    </svg>
  )
