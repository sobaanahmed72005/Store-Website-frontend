...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col font-sans">
      ...
      <main className="max-w-[1100px] w-full mx-auto px-4 sm:px-5 py-6 sm:py-8 flex-1">
        {/* Left-Aligned Title Heading (No Blue Background Banner & No Home/Contact Us Breadcrumb) */}
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-[26px] sm:text-[32px] font-bold text-[#0c4a6e] font-heading tracking-tight">
              Contact Us
            </h1>
          ...
          {sitePhone && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-white text-[13px] font-semibold shadow hover:scale-105 transition-all text-center self-start sm:self-auto"
            >
        ...
        {/* Message Form Card Container */}
        <div className="max-w-[750px] bg-white rounded-2xl p-6 sm:p-8 border border-slate-100 shadow-sm relative overflow-hidden">
